...
Route::group(['middleware' => 'auth:api'], function(){
    // 로그아웃 컨트롤러의 라우터
    Route::get('/users/logout', [\App\Http\Controllers\Api\vi\User\UsersController::class, 'logout']) -> name('api.jwt.logout');
    // 토큰 갱신 컨트롤러의 라우터
    Route::get('/users/refresh', [\App\Http\Controllers\Api\vi\User\UsersController::class, 'refresh']) -> name('api.jwt.refresh');
    //
    Route::get('/users/user', [\App\Http\Controllers\Api\vi\User\UsersController::class, 'User']) -> name('api.jwt.user');
});
